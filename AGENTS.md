...
3. If it is a python project, make sure you make a venv and install all dependecies inside it.
4. Make the smallest safe change possible.
5. Before finishing, update docs/releases.md for shipped work.
6. Every commit must use the required commit format below.
7. If any required file or commit field is missing, the work is incomplete.
...
## README Rules
After every change check and update README.md for that current change.